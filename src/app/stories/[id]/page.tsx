...
// ✅ Await `params` if you're using dynamic server functions
    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-900 to-gray-800 text-white">
      <div className="container mx-auto px-4 py-8">
        <Link href="/stories">
          <Button
            variant="outline"
            className="mb-6 text-yellow-500 border-gray-700"
          >
            ...
            <Card className="bg-gray-800 border-gray-700">
              ...
              <CardContent>
                ...
                <p className="mt-4 text-gray-300">
                  {story.author} has been covering Ethiopian cinema for over 5
                  years, with bylines in multiple international film
                  publications.
                </p>
              </CardContent>
            </Card>
